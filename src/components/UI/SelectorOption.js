    ...
    return (
        <div className={styles.selectorLine} onClick={() => toggle(id, option)}>
            ...
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <motion.path variants={checkCircleStroke} initial="start" animate={anim ? "end" : ""} d="M0.5,10a9.5,9.5 0 1,0 19,0a9.5,9.5 0 1,0 -19,0" cx="10" cy="10" r="9.5"  stroke="#C20707" style={{ zIndex: 1 }} />
